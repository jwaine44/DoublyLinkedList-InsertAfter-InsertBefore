...
class DoublyLinkedList {
    ...
    insertAfter(targetVal, newVal){
        ...
        if(this.isEmpty()){
            ...
            current.next.prev = insertVal;
            insertVal.next = current.next;
            insertVal.prev = current;
    ...
    insertBefore(targetVal, newVal){
        ...
        if(this.isEmpty()){
            ...
            while(current.data != targetVal && current.next != null){
                current = current.next
            }
            ...
            current.prev.next = insertVal;
            insertVal.next = current;
            current.prev = insertVal;
            insertVal.prev = current.prev;
...
console.log(unorderedList.insertAfter(4, 8));
console.log(unorderedList.toArray());
console.log(unorderedList.insertBefore(-2, 9));
console.log(unorderedList.toArray());